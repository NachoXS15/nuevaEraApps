                ...
                <section className="w-3/4 h-[850px] rounded-lg flex flex-col gap-10">
                    <div className="h-1/3 w-full flex items-center gap-5">
                        ...
                        <div className="w-1/3 h-full rounded-lg border border-blue-200 shadow-xl flex gap-10 items-center justify-center px-20">
                            ...
                            <div>
                                <p className="text-xl font-bold underline">Información</p>
                                <span className="text-6xl font-bold text-blue-700">45%</span>
                            </div>
                        </div>
                        <div className="w-1/3 h-full rounded-lg border border-blue-200 shadow-xl flex gap-10 items-center justify-center px-20">
                            <div>
                            ...
                            <div>
                                <p className="text-xl font-bold underline">Información</p>
                                <span className="text-6xl font-bold text-blue-700">15%</span>
                            </div>
                        </div>
                        
                    </div>
                    <div className="h-2/3 w-full flex flex-col justify-center rounded-lg shadow-2xl gap-5 px-20">
                        <h2 className="text-3xl font-bold mt-5">Porcentaje de aumento</h2>
                        <div className="h-full w-full self-baseline flex justify-between">
                            {months.map(month => (
